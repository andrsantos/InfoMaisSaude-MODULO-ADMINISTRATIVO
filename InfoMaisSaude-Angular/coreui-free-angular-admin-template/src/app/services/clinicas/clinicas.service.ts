...
listarConsultasPorClinica(idDaClinica: any, data?: string) {
    ...
    return this.http.get<ConsultasPorClinicaReadResponse[]>(
      `${this.apiUrl}/agendamentos/consultas-clinica/${idDaClinica}`, 
      { params }
    );
  }
}
