...
var ChartjsComponent = class _ChartjsComponent {
   ...
   * @default true
   */
  customTooltips = input(true, ...ngDevMode ? [{
    debugName: "customTooltips",
   ...
   * @return string
   */
  idInput = input(`c-chartjs-${nextId++}`, ...ngDevMode ? [{
    debugName: "idInput",
    alias: "id"
  }] : [{
    alias: "id"
   ...
   */
  optionsInput = input({}, ...ngDevMode ? [{
    debugName: "optionsInput",
    alias: "options"
  }] : [{
    alias: "options"
  }]);
  options = linkedSignal(this.optionsInput, ...ngDevMode ? [{
    debugName: "options"
  }] : []);
  /**
   * The plugins array that is passed into the Chart.js chart
   */
  plugins = input([], ...ngDevMode ? [{
    debugName: "plugins"
  }] : []);
  /**
  ...
  chartDataConfig = computed(() => {
    ...
    debugName: "chartDataConfig"
  }] : []);
  chartOptions = computed(() => this.options() ?? {}, ...ngDevMode ? [{
    debugName: "chartOptions"
  }] : []);
  ...
  static ɵfac = function ChartjsComponent_Factory(__ngFactoryType__) {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function ChartjsComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵdomListener("click", function ChartjsComponent_Template_canvas_click_0_listener($event) {
          ɵɵrestoreView(_r1);
      ...
      if (rf & 2) {
        ɵɵdomProperty("height", ctx.height() || null)("id", ctx.id)("width", ctx.width() || null);
      }
    },
...
var ChartjsModule = class _ChartjsModule {
  static ɵfac = function ChartjsModule_Factory(__ngFactoryType__) {
